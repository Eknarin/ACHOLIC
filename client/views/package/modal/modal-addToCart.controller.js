...
angular.module('acholic')
  .controller('AddToCartModalCtrl',['$scope','$uibModalInstance','Auth','Bookmark','folderData','userData','packageData', function ($scope, $uibModalInstance,Auth,Bookmark,folderData,userData, packageData) {
   	$scope.folder_name = "";
